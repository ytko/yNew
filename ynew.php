...
class yNew
{
    ...
    public static $path;
    //public static $altPaths,
    public static $delimiter = '_';
    public static $extension = 'php';
    public static $allowMagic = true; // Allows sending class name as static method name
     ...
     */
    public static function createArgs($className, array $arguments = array())
    {
    ...
    {
        return static::createArgs($class, array_slice(func_get_args(), 1));
    }
    ...
    public static function classPath($class)
    {
        ...
        return
            static::$basePath . (static::$path ? '/' . static::$path : '') . ($classPath ? '/' . $classPath : '') . '/'
